/**
 * Entry shim for @nxg-org/mineflayer-physics-util when installed from GitHub (src only, no dist).
 * Re-exports from node_modules src with type-only exports split for rspack.
 */
